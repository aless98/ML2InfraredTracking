...
namespace MagicLeap
{
    ...
    {
        private static readonly string Arg_EnableDebug = "--enableDebug";
        ...
        private void BuildAllScenes()
        {
            ...
            if (IsArgSet(Arg_EnableDebug))
            {
                apkName = $"{apkName}-debug";
            }
        ...
        {
            UnityEditor.BuildOptions buildOptions = BuildOptions.Development;
            if (IsArgSet(Arg_EnableDebug))
            {
