...
public class MLVoiceIntentsConfiguration : ScriptableObject
{
    ...
    /// </summary>
    public List<JSONData> AllVoiceIntents = new List<JSONData>();
    ...
    /// Max Voice Intents Supported: 100
    /// </summary>
    public List<CustomVoiceIntents> VoiceCommandsToAdd = new List<CustomVoiceIntents>();
    ...
    public List<SlotData> SlotsForVoiceCommands = new List<SlotData>();
    ...
    {
        SlotsForVoiceCommands ??= new List<SlotData>();
